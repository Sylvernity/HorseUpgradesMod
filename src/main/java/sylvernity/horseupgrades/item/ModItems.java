...
public class ModItems {
    ...
    public static final RegistryObject<Item> NETHERITE_HORSESHOE_BAR = ITEMS.register("netherite_horseshoe_bar", () -> new HorseshoeBarItem("netherite_horseshoe_bar", new Item.Properties().stacksTo(16).tab(ModCreativeModeTab.HORSE_UPGRADES_TAB)));
