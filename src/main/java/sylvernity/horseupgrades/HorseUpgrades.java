...
public class HorseUpgrades
{
    ...
    public static final RegistryObject<Item> WOODEN_HORSESHOE = ITEMS.register("wooden_horseshoe", () -> new HorseArmorItem(11, new ResourceLocation("horseupgrades", "models/item/wooden_horseshoe.png"), (new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC))));
